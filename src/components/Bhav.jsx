...
{
  name: "TOTALTRADES",
  selector: (row) => row["TOTALTRADES"],
  sortable: true,
},
{
  name: "Pivot",
  selector: (row) => row["Pivot"],
  sortable: true,
},
{
  name: "R1",
...
{
  name: "FIBR1",
  selector: (row) => row["FIBR1"],
  sortable: true,
},
{
  name: "FIBS1",
  selector: (row) => row["FIBS1"],
  sortable: true,
},
{
  name: "FIBR2",
  selector: (row) => row["FIBR2"],
  sortable: true,
},
{
  name: "FIBS2",
  selector: (row) => row["FIBS2"],
  sortable: true,
}
];

export default function Bhav() {
  const sheetsQuery = useApiCall(["sheets", "iv"], "get", "https://eagle.bitstreak.in/bhav");
